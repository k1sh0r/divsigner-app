...
import RealFaultyTerminal from "../real/FaultyTerminal/FaultyTerminal";

/**
 * Wrapper that adapts the React Bits FaultyTerminal background
...
export default function FaultyTerminal({
  ...
  return (
    ...
    >
      <RealFaultyTerminal {...(params as any)} />
    </div>
  );
}
