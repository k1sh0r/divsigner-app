...
import RealGradientBlinds from "../real/GradientBlinds/GradientBlinds";

/**
 * Wrapper that adapts the React Bits GradientBlinds background
...
export default function GradientBlinds({
  ...
  return (
    ...
    >
      <RealGradientBlinds {...(params as any)} />
    </div>
  );
}
