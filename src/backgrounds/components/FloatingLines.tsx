...
import RealFloatingLines from "../real/FloatingLines/FloatingLines";

/**
 * Wrapper that adapts the React Bits FloatingLines background
...
export default function FloatingLines({
  ...
  return (
    ...
    >
      <RealFloatingLines {...(params as any)} />
    </div>
  );
}
