...
import RealPrismaticBurst from "../real/PrismaticBurst/PrismaticBurst";

/**
 * Wrapper that adapts the React Bits PrismaticBurst background
...
export default function PrismaticBurst({
  ...
  return (
    ...
    >
      <RealPrismaticBurst {...(params as any)} />
    </div>
  );
}
