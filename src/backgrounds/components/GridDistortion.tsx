...
import RealGridDistortion from "../real/GridDistortion/GridDistortion";

/**
 * Wrapper that adapts the React Bits GridDistortion background
...
export default function GridDistortion({
  ...
  return (
    ...
    >
      <RealGridDistortion {...(params as any)} />
    </div>
  );
}
