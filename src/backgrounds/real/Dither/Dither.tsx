...
// Wrap once at module scope — calling wrapEffect() inside the render created a
// new effect component type on every render, remounting the post-process pass
// and stalling the animation whenever the tree re-rendered.
